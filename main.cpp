...
void gamepage(SDL_Renderer *m_renderer)
{
    ...
    SDL_PumpEvents();
    if (key[SDL_SCANCODE_Z]) dx_ball=-30,dy_ball=-30;
    ...
    if (head_fire_ball_left && x_ball>=x_right-30 && y_ball>=y_right-90)
    {
    ...
    if (head_fire_ball_right && x_left>=x_ball-60 && y_ball>=y_left-90)
    {
